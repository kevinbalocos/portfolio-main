...
export const AnimatedSkillCard: React.FC<AnimatedSkillCardProps> = ({
  ...
  const baseMotionProps = {
    ...
    className:
      "px-3 py-1.5 bg-gradient-to-r from-teal-500/10 to-blue-500/10 border border-teal-400/30 text-teal-300 rounded font-mono text-sm relative overflow-hidden cursor-pointer group",
  } as const;
